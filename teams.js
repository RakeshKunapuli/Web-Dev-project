...
function makethisinclick(res) {
  window.location.open(`./playerdetails.html?name=${res}`)
}
...
teamsDetails.map((item)=>{
 ...
 return tableTeam.innerHTML+=`
  ...
  <div class="accordion-item">
    ...
    <div id="collapseTwo" style ="z-index:-3"  class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <strong>TEAM ICON :</strong> 
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingThree">
      <button style ="z-index:-1" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
        PLAYERS IN THE TEAM
      </button>
    </h2>
